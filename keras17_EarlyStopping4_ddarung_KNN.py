...
hist = model.fit(x_train, y_train, epochs=5000, batch_size=10, validation_split=0.2, verbose=1, callbacks=[es])
...
submission.to_csv(path_save + 'submit_ES+KNN_0308_0550.csv')
